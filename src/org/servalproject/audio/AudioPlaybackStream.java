...
public class AudioPlaybackStream extends AudioStream {
	...
	public AudioPlaybackStream(AudioManager am,	int streamType, int sampleRateInHz,	int channelConfig, int audioFormat, int minimumBufferSize)
			throws IOException {
		...
		//float maxVolume = this.audioTrack.getMaxVolume();
